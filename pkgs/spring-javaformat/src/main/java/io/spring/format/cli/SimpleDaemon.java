...
public class SimpleDaemon implements Daemon, Runnable {
    ...
    public void init(DaemonContext context) throws Exception {
        ...
        // Dump a message
        System.err.println("SimpleDaemon: loading on port " + server.getLocalPort());
    }
    ...
    public static class Handler implements Runnable {
        ...
        public void run() {
            ...
            System.err
                    .println("SimpleDaemon: connection " + this.number + " opened from " + this.socket.getInetAddress());
            try {
            ...
            while (true) {
                try {
                    ...
                    switch (x) {
                        ...
                        // Create a file
                        case '3':
                            String name = this.getDirectoryName() + "/SimpleDaemon." + this.getConnectionNumber()
                                          + ".tmp";
                            try {
                        ...
                        case '6':
                            String name1 = this.getDirectoryName() + "/a/b/c/d/e" + "/SimpleDaemon."
                                           + this.getConnectionNumber() + ".tmp";
                            try {
