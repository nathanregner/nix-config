...
rustPlatform.buildRustPackage rec {
  pname = "alacritty";
  version = "0.15.1-fa36b3a" + lib.optionalString withGraphics "-graphics";
  ...
  src =
    ...
    if !withGraphics then
      fetchFromGitHub {
        owner = "alacritty";
        repo = "alacritty";
        rev = "fa36b3abb165d26595bb8b9c74042dd74ed0f235";
        hash = "sha256-M8WCaY4NSrvpbsmIXvZ80e9Cc2KFKVmQ/sfq204WhHU=";
      }
