...
-- vim.treesitter.language.get_lang("javascriptreact")
-- vim.treesitter.language.get_filetypes("javascriptreact")

local create_postfix = function(opts)
  for lang, ts_langs in pairs({
    javascript = { "javascript" },
    javascriptreact = { "javascript" },
    typescript = { "typescript" },
    typescriptreact = { "tsx" },
  }) do
    for _, ts_lang in ipairs(ts_langs) do
