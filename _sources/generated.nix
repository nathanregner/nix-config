...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  blink-cmp = {
    ...
    src = fetchFromGitHub {
      ...
      sha256 = "sha256-uL1g5zhTpWfdbCqE+JYFH+2uDj9MT86vLTyKEweQesg=";
    };
    cargoLock."Cargo.lock" = {
      lockFile = ./blink-cmp-v0.11.0/Cargo.lock;
      outputHashes = {
        "frizbee-0.1.0" = "sha256-Gbf6EIdnLVkJlJjJlE4WIwSqyA7q0VVMZpE8njnAGPY=";
      };
    };
  };
  btrfs-snapshot-diff = {
